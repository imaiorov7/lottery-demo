      ...
      <nav className="border-b border-gray-800 bg-gray-900/50 backdrop-blur">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            {user ? (
              <>
                <Link to="/my-tickets" className="text-sm text-gray-300 hover:text-white transition-colors">My Tickets</Link>
                <Link to="/my-coupons" className="text-sm text-gray-300 hover:text-white transition-colors flex items-center gap-1">🎟️ Coupons</Link>
              ...
              <>
                ...
                <Link to="/register" className="text-sm bg-brand-500 hover:bg-brand-600 px-4 py-2 rounded-lg transition-colors">Sign Up</Link>
              </>
            )}
          </div>
        </div>
